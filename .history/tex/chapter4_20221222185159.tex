...
\section{نمرات سه‌گانه تاریک}
میانگین و انحراف معیار نمره کل سه‌گانه تاریک شرکت‌کنندگان 
به ترتیب \CompareDarkTriadStatisticsRef

\CompareDarkTriadStatisticsCustomTable
