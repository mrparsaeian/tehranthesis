...
\begin{figure}[htpb]
    ...
    \caption{فراوانی دسته‌های رویکرد ارزش اجتماعی با توجه به جنسیت}
...
\begin{figure}[htpb]
    ...
    \caption{نمودار پراکنش نمره رویکرد ارزش اجتماعی را نسبت به نمره سه‌گانه تاریک}
