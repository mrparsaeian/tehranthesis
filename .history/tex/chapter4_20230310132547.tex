...
\end{figure}
شکل 
\ref{fig:PDFGramDTRSex}
توزیع چگالی احتمال نمره سه‌گانه‌تاریک را در دو گروه جنسیتی زن و مرد نشان می‌دهد.
% \begin{figure}[htpb]
%     \centering
...
در نمودار 
\ref{fig:CorrPlotIntervals}
ماتریس همبستگی زیر‌مقیاس‌های سه‌گانه‌تاریک با نمره شاخص رویکرد اجتماعی و دو نمره مجمعه پرداخت به خود و پرداخت به دیگری
را نشان می‌دهد.
از میان داده‌های این جدول نمره همبستگی زیر‌مقیاس‌های
سه‌گانه‌تاریک و نمره سه‌گانه‌تاریک با رویکرد‌ارزش‌اجتماعی و پرداختی به دیگری منفی است.
نمره همبستگی زیر‌مقیاس‌های
سه‌گانه‌تاریک و نمره سه‌گانه‌تاریک با عدد مجموع پرداختی به خود مثبت است.
\begin{figure}[htpb]
    \centering
...
میانگین رتبه‌ای متغیر‌های ترتیبی پرسشنامه اطلاعات دموگرافیک
درج شده‌است.
\LatexFromStatisticsRankMeansCommand
همچنین در تصاویر زیر نمودار میله‌ای متغیر‌های ترتیبی
تحصیلات،
دسترسی‌به‌اطلاعات،
رضایت‌شغلی،
سلامت‌روان،
...
اکثر آزمودنی‌ها به ترتیب دارای تحصیلات کارشناسی ارشد و کارشناسی بوده‌اند.
افرادی که از موقعیت شغلی خود ناراضی بوده‌اند چه شاغل و چه غیر شاغل بیشتر از گروه‌های دیگر هستند.
