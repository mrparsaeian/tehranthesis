...
بخش های مختلف آزمایش را به درستی انجام داده بودند، به این دلیل که شماره تلفن نامعتبر
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{./img/FrequencyBehaviorPhnoneNumber.png}
    \caption{فراوانی دسته‌بندی‌های تغییر رفتار بر اساس جنسیت}
    \label{fig:FrequencyBehaviorPhnoneNumber}
\end{figure}

فراوانی هر یک از رفتارها در
تصویر \ref{fig:FrequencyBehaviorPhnoneNumber}
مشخص است.
...
فراوانی نمره‌های پرسشنامه سه‌گانه تاریک مشخص شده است.
