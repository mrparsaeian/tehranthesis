...
\begin{table}
    \centering
        ...
        \begin{tabular}{r|L|L}
            ...
            1    & \XYNullDarkTriadXXSize       & \textit{\gls{XX}}         \\
            2    & \XYNullDarkTriadXYSize       & \textit{\gls{NullX}}      \\
            3    & \XYNullDarkTriadNullXSize    & \textit{\gls{NullNull}}   \\
            3    & \XYNullDarkTriadXNullSize    & \textit{\gls{NullNull}}   \\
            3    & \XYNullDarkTriadNullNullSize & \textit{\gls{NullX}}
        \end{tabular}
\end{table}
