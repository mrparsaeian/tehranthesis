...
\usepackage{natbib}
% \newcommand{\citelatin}[1]{\citep{#1}\LTRfootnote{\citeauthor*{#1}}}
...
\hypersetup{
	pdftitle={Investigation of decision-making in sharing personal information of others},
	pdfauthor={Mohamad Rasoul Parsaeian},
	pdfsubject={Master Thesis},
	pdfkeywords={secondary use of information, personal information, decision-making, dark triad, social value orientation},
	pdfdirection={R2L}
}
...
%  ^ برای وارد کردن پی دی اف پرسش‌نامه ها از سایت
%  ^ برای وارد کردن پی دی اف پرسش‌نامه ها از سایت
% \usepackage{pdfpages}
% ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%
%  ^ علامت تیک و ضرددر
...
\usepackage{hyperref}
%  ^ برای قرار دادن اتوماتیک دلار در جدول
