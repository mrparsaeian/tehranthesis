...
\newcommand{
 ...
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ noOfIndividualisticParticipants =  42 
\newcommand{
    \noOfIndividualisticParticipants
}[0]{42\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ noOfCompetitiveParticipants =  67 
\newcommand{
    \noOfCompetitiveParticipants
}[0]{67\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ noOfCooperativeParticipants =  4 
\newcommand{
    \noOfCooperativeParticipants
}[0]{4\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ noOfAltruisticParticipants =  12 
\newcommand{
