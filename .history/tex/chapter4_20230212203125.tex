...
\end{figure}
\section{تغییر در رفتار(قبل و بعد از پرسشنامه دموگرافیک و سه‌گانه‌تاریک و تحت تاثیر 
\!\textit{
    \gls{Temptation}
})}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{./img/ScatterDTRAge.png}
    \caption{نمودار پراکنش سن نسبت به نمره سه‌گانه تاریک}
    \label{fig:ScatterDTRAge}
\end{figure}
در شکل
\ref{fig:ScatterDTRAge}
نمودار پراکنش سن نسبت به نمره سه‌گانه تاریک مشخص شده‌است.
شکل
