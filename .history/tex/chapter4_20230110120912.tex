...
\lr{pandas}
 و
\lr{scipy}
پردازش شدند. داده‌هایی که فاقد اطلاعات بودند و یا اطلاعات وارد شده توسط آزمودنی
مانند نام و نام‌خانوادگی و شماره تلفن‌ها مخدوش و غیر صحیح بودند، پاکسازی شدند. 
از تعداد $\InitialSampleSizeTotal$
...
$1$
نفر دیگر نیز به جای شماره تلفن، ایمیل خود را وارد کرده بود. 
از نتایج حذف شدند. داده‌های این افراد نیز از نتایج جذف شدند
و در نهایت 
