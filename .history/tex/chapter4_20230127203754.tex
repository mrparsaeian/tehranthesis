...
نفر چهار بخش ابتدایی آزمایش شامل
\textit{معرفی اولیه}،
\textit{پرسشنامه اول}،
...
داده مربوط به آزمودنی‌ای که عدم تمایل به پاسخ‌گویی برای سوال جنسیت را انتخاب کرده بود هم به همین ترتیب حذف شد.
در نهایت
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{./img/SVOAgainstPopulationSexBarPlot.pdf}
