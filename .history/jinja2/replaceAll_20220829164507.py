...
numebrOfVariables = pd.Series({{'variableName': 'InitialSampleSize', 'variableValue': 512}, {
                              'variableName': 'CleanedSampleSize', 'variableValue': 400}, {'variableName': 2, 'variableValue': 1}})
