...
\newcommand{
 ...
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ XYNullDarkTriadXXXYNullDarkTriadNullNullTTestPValueReport =  $P-Value>0.05$ 
\newcommand{
    \XYNullDarkTriadXXXYNullDarkTriadNullNullTTestPValueReport
}[0]{$P-Value>0.05$\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ XYNullDarkTriadNullXXYNullDarkTriadNullNullTTestPValueReport =  $P-Value>0.05$ 
\newcommand{
    \XYNullDarkTriadNullXXYNullDarkTriadNullNullTTestPValueReport
}[0]{$P-Value>0.05$\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ XYNullDarkTriadXXXYNullDarkTriadNullXTTestPValueReport =  $P-Value>0.05$ 
\newcommand{
    \XYNullDarkTriadXXXYNullDarkTriadNullXTTestPValueReport
}[0]{$P-Value>0.05$\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ XYNullDarkTriadXXSize =  43 
\newcommand{
    \XYNullDarkTriadXXSize
}[0]{43\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ XYNullDarkTriadXYSize =  2 
\newcommand{
    \XYNullDarkTriadXYSize
}[0]{2\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ XYNullDarkTriadNullXSize =  7 
\newcommand{
    \XYNullDarkTriadNullXSize
}[0]{7\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ XYNullDarkTriadXNullSize =  2 
\newcommand{
    \XYNullDarkTriadXNullSize
}[0]{2\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 % ^ XYNullDarkTriadNullNullSize =  107 
\newcommand{
    \XYNullDarkTriadNullNullSize
}[0]{107\,}
 % ^ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
